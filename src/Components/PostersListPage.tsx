...
import { getPostersThunk, getItemCategoriesThunk, getPostersFilteredThunk, getPosterStatusesThunk } from '../store/posterSlice';
...
export const PostersListPage = () => {
   ...
   const [isPet, setIsPet] = useState<string>('')
   ...
   return (
      <Box sx={{
         ...
         {isNotAdmin === 'false' && <p style={{ marginBottom: '48px' }}><Link to='/users'>Перейти к управлению пользователями</Link></p>}
